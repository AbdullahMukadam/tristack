...
const iconButtonClass =
  "inline-flex size-7 shrink-0 items-center justify-center rounded-md p-0 text-fd-muted-foreground transition-colors hover:bg-transparent hover:text-fd-foreground [&_svg]:size-4";
...
function NavTitle() {
  ...
  return (
    <Link aria-label="TriStack home" className={className} href="/">
      {navTitle}
    </Link>
  );
}
    ...
    <header {...props} className={cn("h-14 shrink-0", className)}>
      <div className="flex h-14 items-center gap-2 border-b px-4 md:px-6">
        ...
        <FullSearchTrigger
          ...
          className={cn(
            labelClass,
            "h-7 w-full max-w-[180px] rounded-md border bg-transparent px-2 py-0 text-fd-muted-foreground transition-colors hover:bg-transparent hover:text-fd-foreground max-lg:hidden [&_kbd]:rounded-md [&_kbd]:border [&_kbd]:bg-transparent [&_kbd]:px-1 [&_svg]:size-3.5",
          )}
        />
