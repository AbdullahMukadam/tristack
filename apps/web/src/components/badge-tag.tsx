...
const ORB_BASE = "pointer-events-none absolute h-[200%] w-[200%] mix-blend-normal blur-md";
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden bg-background border border-border shadow-sm shadow-accent rounded-full px-2 py-1 flex items-center justify-center">
        <span className="relative z-10 text-xs font-semibold tracking-wide text-background drop-shadow-sm">
          {version}
        </span>
        <span aria-hidden className="pointer-events-none absolute inset-0 opacity-100">
          <span
            className={cn(
              ORB_BASE,
              "-top-1/2 animate-[badge-gradient-border_6s_ease-in-out_infinite,badge-gradient-1_12s_ease-in-out_infinite_alternate]",
            )}
          ...
          <span
            className={cn(
              ORB_BASE,
              "right-0 top-0 animate-[badge-gradient-border_6s_ease-in-out_infinite,badge-gradient-2_12s_ease-in-out_infinite_alternate]",
            )}
          ...
          <span
            className={cn(
              ORB_BASE,
              "bottom-0 left-0 animate-[badge-gradient-border_6s_ease-in-out_infinite,badge-gradient-3_12s_ease-in-out_infinite_alternate]",
            )}
          ...
          <span
            className={cn(
              ORB_BASE,
              "-bottom-1/2 right-0 animate-[badge-gradient-border_6s_ease-in-out_infinite,badge-gradient-4_12s_ease-in-out_infinite_alternate]",
            )}
