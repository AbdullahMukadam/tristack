    ...
    case "uv":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          <title>uv</title>
          <circle cx="12" cy="12" r="10" stroke="#ffc24b" strokeWidth="2" fill="none" />
          <circle cx="12" cy="12" r="6.5" fill="#ffc24b" />
          <circle cx="12" cy="12" r="3" fill="#f0fdf4" />
        </svg>
      );
    case "pipx":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="currentColor">
          <title>pipx</title>
          <path d="M5 10.4 9.6 19l-3.5.1-2.9 2.8V9.5zM11.7 2.6l2.8 2.8-3.7 3.6 1.8 1.8 3.7-3.7 2.9 2.9 1.9-2L10.5 2.6zM14.4 14l3.7-3.6 1.8 1.8-3.7 3.6zm2.6 2.6 3.7-3.7 1.9 1.9-3.7 3.7z" />
        </svg>
      );
    case "npm":
      return (
