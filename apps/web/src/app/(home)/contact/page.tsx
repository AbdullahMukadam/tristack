...
export default function ContactPage() {
  return (
    <TrustPage icon={Mail} title="Contact" description={description}>
      <TrustSection title="Bug reports">
        <p>
      ...
      <TrustSection title="Feature requests">
        <p>
      ...
      <TrustSection title="General contact">
        <p>
