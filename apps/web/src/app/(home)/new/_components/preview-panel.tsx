...
export function PreviewPanel({ stack, selectedFilePath, onSelectFile }: PreviewPanelProps) {
  ...
  if (isLoading && !tree) {
    return (
      <div className="flex h-full items-center justify-center rounded-md border bg-fd-background">
  ...
  if (!tree) {
    return (
      <div className="flex h-full items-center justify-center rounded-md border bg-fd-background text-fd-muted-foreground">
  ...
  return (
    <div className="@container flex h-full flex-col overflow-hidden rounded-md border bg-fd-background">
      {/* Stats bar */}
      <div className="@lg:gap-4 flex flex-wrap items-center gap-x-3 gap-y-1 border-b px-3 py-2">
        ...
        {mobileView === "code" && selectedFile && (
          <button
            ...
            className="builder-focus-ring pointer-coarse:py-2 @lg:hidden flex items-center gap-1 py-0.5 text-xs font-medium text-fd-muted-foreground transition-colors duration-150 hover:text-fd-foreground"
          >
        ...
        <div
          className={cn(
            "flex shrink-0 items-center gap-1.5 text-xs font-medium text-fd-muted-foreground tabular-nums",
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          <Tooltip>
            <TooltipTrigger className="pointer-coarse:py-2 flex items-center gap-1 text-xs font-medium text-fd-muted-foreground transition-colors duration-150 hover:text-fd-foreground">
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>
                ...
                database provider setup and certain addons (Fumadocs, Starlight, etc.) require CLI
                execution and are not shown here.
              </p>
            </TooltipContent>
          </Tooltip>
