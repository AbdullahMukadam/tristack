...
/** How this run is being driven. */
export type InvocationMode = "json" | "api" | "mcp" | "yes" | "interactive" | "flags";
...
let processMode: InvocationMode | undefined;

export function setProcessMode(mode: InvocationMode | undefined): void {
  processMode = mode;
}

export function getProcessMode(): InvocationMode | undefined {
  return processMode;
}
 ...
 */
export function resolveInvocationMode(yes?: boolean): InvocationMode {
