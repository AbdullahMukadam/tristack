# Contributing to TriStack

Thank you for your interest in contributing to TriStack! This document provides guidelines and setup instructions for contributors.
...
- **CLI**: [`apps/cli`](apps/cli) - The scaffolding CLI tool (`tristack`)
...
2. **Link the CLI globally** (optional, for testing anywhere in your system)
   ...
   Now you can use `tristack` from anywhere in your system.
...
By contributing to TriStack, you agree that your contributions will be licensed under the MIT License.
